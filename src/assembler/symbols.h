...
namespace assembler 
{
  ...
  class Section {
    ...
    public:
      ...
      void AddSymbol(Symbol& sym, Assembler* ass, ParseTree* node);
      bool ValidRange(size_t s, size_t e, Symbol& sym, Assembler* ass, ParseTree* node);
  ...
  class SymbolTable {
    ...
    public:
      ...
      void AddSymbol(Symbol& s, Assembler* ass, ParseTree* node);
